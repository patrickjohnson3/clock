export function createUI(defaults) {
  const refs = {
    ...
    toggles: {
      ...
      leadingZero: document.getElementById("leadingZeroToggle"),
      ...
      wakeLock: document.getElementById("wakeLockToggle"),
  ...
  function setControlsFromState(state) {
    ...
    setChecked(refs.toggles.leadingZero, state.leadingZero);
    ...
    setChecked(refs.toggles.wakeLock, state.wakeLock);
